                    ...
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tbody class="text-gray-600 text-sm font-light" >
                            ...
                            <tr  class="border-b border-gray-200 hover:bg-gray-100" v-for="emp in employees" :key="emp.id">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                        <p class="font-medium">{{ emp.user.phone}}</p>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center mb-2">
                                        <span v-if="emp.status == 1" class="text-md font-semibold text-green-500">Active</span>
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <button class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110" @click="updateEmployee(emp.id)">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <!-- <button class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110" @click="deleteEmployee(emp.id)"> -->
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
